...
Label(root,image=logo).place(x=113,y=10)

Heading=Label(root,text="TRACK NUMBERS",font=("arial",15,"bold"))
Heading.place(x=96,y=140)
...
country=Label(root,text="Country:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
country.place(x=50,y=400)

sim=Label(root,text="SIM:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
sim.place(x=200,y=400)

zone=Label(root,text="TimeZone:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
zone.place(x=50,y=450)

clock=Label(root,text="Phone Time:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
clock.place(x=200,y=450)

longitude=Label(root,text="Longitude:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
longitude.place(x=50,y=500)

latitude=Label(root,text="Latitude:",bg="#ba0000",fg="black",font=("arial",10,"bold"))
